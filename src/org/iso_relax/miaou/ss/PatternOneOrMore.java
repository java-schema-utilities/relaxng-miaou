...
/**
 * <b>PatternOneOrMore</b> is generated from simpleSyntax.rngby Relaxer.
 ...
 */
public class PatternOneOrMore implements java.io.Serializable, IRNSContainer, IRVisitable, IRNode, IPatternChoice {
     ...
     * @param stack
     */
    public PatternOneOrMore(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public PatternOneOrMore(Document doc) {
     ...
     * @param element
     */
    public PatternOneOrMore(Element element) {
        setup(element);
    }
     ...
     */
    public PatternOneOrMore(File file) throws IOException, SAXException, ParserConfigurationException {
        setup(file);
    }
     ...
     * @exception ParserConfigurationException
     */
    public PatternOneOrMore(String uri) throws IOException, SAXException, ParserConfigurationException {
        setup(uri);
    }
     ...
     * @exception ParserConfigurationException
     */
    public PatternOneOrMore(URL url) throws IOException, SAXException, ParserConfigurationException {
        setup(url);
    }
     ...
     * @exception ParserConfigurationException
     */
    public PatternOneOrMore(InputStream in) throws IOException, SAXException, ParserConfigurationException {
        setup(in);
    }
     ...
     * @exception ParserConfigurationException
     */
    public PatternOneOrMore(InputSource is) throws IOException, SAXException, ParserConfigurationException {
        setup(is);
    }
     ...
     * @exception ParserConfigurationException
     */
    public PatternOneOrMore(Reader reader) throws IOException, SAXException, ParserConfigurationException {
        setup(reader);
    }

    /**
     * Initializes the <code>PatternOneOrMore</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>PatternOneOrMore</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>PatternOneOrMore</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    /**
     * Initializes the <code>PatternOneOrMore</code> by the File <code>file</code>.
     *
     * @param file
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>PatternOneOrMore</code>
     * by the String representation of URI <code>uri</code>.
     *
     * @param uri
     * @exception IOException
    ...
    /**
     * Initializes the <code>PatternOneOrMore</code> by the URL <code>url</code>.
     *
     * @param url
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>PatternOneOrMore</code> by the InputStream <code>in</code>.
     *
     * @param in
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>PatternOneOrMore</code> by the InputSource <code>is</code>.
     *
     * @param is
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>PatternOneOrMore</code> by the Reader <code>reader</code>.
     *
     * @param reader
     * @exception IOException
     * @exception SAXException
     ...
     * for the <code>PatternOneOrMore</code>.
     *
     * @param element
     * @return boolean
     */
     ...
     * is valid for the <code>PatternOneOrMore</code>.
