...
/**
 * <b>NameClassNsName</b> is generated from simpleSyntax.rngby Relaxer.
...
public class NameClassNsName implements java.io.Serializable, IRNSContainer, IRVisitable, IRNode, INameClassChoice {
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://relaxng.org/ns/structure/1.0", "nsName");
    ...
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://relaxng.org/ns/structure/1.0", "nsName")) {
            return (false);
        }
