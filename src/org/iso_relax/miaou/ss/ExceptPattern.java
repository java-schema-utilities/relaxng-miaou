...
/**
 * <b>ExceptPattern</b> is generated from simpleSyntax.rngby Relaxer.
 ...
 */
public class ExceptPattern implements java.io.Serializable, IRNSContainer, IRVisitable, IRNode {
     ...
     * @param stack
     */
    public ExceptPattern(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public ExceptPattern(Document doc) {
     ...
     * @param element
     */
    public ExceptPattern(Element element) {
        setup(element);
    }
     ...
     */
    public ExceptPattern(File file) throws IOException, SAXException, ParserConfigurationException {
        setup(file);
    }
     ...
     * @exception ParserConfigurationException
     */
    public ExceptPattern(String uri) throws IOException, SAXException, ParserConfigurationException {
        setup(uri);
    }
     ...
     * @exception ParserConfigurationException
     */
    public ExceptPattern(URL url) throws IOException, SAXException, ParserConfigurationException {
        setup(url);
    }
     ...
     * @exception ParserConfigurationException
     */
    public ExceptPattern(InputStream in) throws IOException, SAXException, ParserConfigurationException {
        setup(in);
    }
     ...
     * @exception ParserConfigurationException
     */
    public ExceptPattern(InputSource is) throws IOException, SAXException, ParserConfigurationException {
        setup(is);
    }
     ...
     * @exception ParserConfigurationException
     */
    public ExceptPattern(Reader reader) throws IOException, SAXException, ParserConfigurationException {
        setup(reader);
    }

    /**
     * Initializes the <code>ExceptPattern</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>ExceptPattern</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>ExceptPattern</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    /**
     * Initializes the <code>ExceptPattern</code> by the File <code>file</code>.
     *
     * @param file
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>ExceptPattern</code>
     * by the String representation of URI <code>uri</code>.
     *
     * @param uri
     * @exception IOException
    ...
    /**
     * Initializes the <code>ExceptPattern</code> by the URL <code>url</code>.
     *
     * @param url
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>ExceptPattern</code> by the InputStream <code>in</code>.
     *
     * @param in
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>ExceptPattern</code> by the InputSource <code>is</code>.
     *
     * @param is
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>ExceptPattern</code> by the Reader <code>reader</code>.
     *
     * @param reader
     * @exception IOException
     * @exception SAXException
     ...
     * for the <code>ExceptPattern</code>.
     *
     * @param element
     * @return boolean
     */
     ...
     * is valid for the <code>ExceptPattern</code>.
