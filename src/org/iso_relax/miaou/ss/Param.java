...
/**
 * <b>Param</b> is generated from simpleSyntax.rngby Relaxer.
...
public class Param implements java.io.Serializable, IRNSContainer, IRVisitable, IRNode {
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://relaxng.org/ns/structure/1.0", "param");
    ...
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://relaxng.org/ns/structure/1.0", "param")) {
            return (false);
        }
