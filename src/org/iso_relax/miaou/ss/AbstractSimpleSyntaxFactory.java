...
public abstract class AbstractSimpleSyntaxFactory implements ISimpleSyntaxFactory {
    ...
    public IRNode create(Element element) throws IOException, SAXException, ParserConfigurationException {
        if (NameClassNsName.isMatch(element)) {
            ...
            node.setup(element);
            return(node);
        } else if (PatternData.isMatch(element)) {
     ...
     * @return NameClass
     */
    public NameClass createNameClass(RStack stack) {
        NameClass nameClass_ = createNameClass();
        nameClass_.setup(stack);
        return (nameClass_);
    }
