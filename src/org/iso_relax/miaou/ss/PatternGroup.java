...
/**
 * <b>PatternGroup</b> is generated from simpleSyntax.rngby Relaxer.
 ...
 */
public class PatternGroup implements java.io.Serializable, IRNSContainer, IRVisitable, IRNode, IPatternChoice {
     ...
     * @param stack
     */
    public PatternGroup(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public PatternGroup(Document doc) {
     ...
     * @param element
     */
    public PatternGroup(Element element) {
        setup(element);
    }
     ...
     */
    public PatternGroup(File file) throws IOException, SAXException, ParserConfigurationException {
        setup(file);
    }
     ...
     * @exception ParserConfigurationException
     */
    public PatternGroup(String uri) throws IOException, SAXException, ParserConfigurationException {
        setup(uri);
    }
     ...
     * @exception ParserConfigurationException
     */
    public PatternGroup(URL url) throws IOException, SAXException, ParserConfigurationException {
        setup(url);
    }
     ...
     * @exception ParserConfigurationException
     */
    public PatternGroup(InputStream in) throws IOException, SAXException, ParserConfigurationException {
        setup(in);
    }
     ...
     * @exception ParserConfigurationException
     */
    public PatternGroup(InputSource is) throws IOException, SAXException, ParserConfigurationException {
        setup(is);
    }
     ...
     * @exception ParserConfigurationException
     */
    public PatternGroup(Reader reader) throws IOException, SAXException, ParserConfigurationException {
        setup(reader);
    }

    /**
     * Initializes the <code>PatternGroup</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>PatternGroup</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>PatternGroup</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://relaxng.org/ns/structure/1.0", "group");
    ...
    /**
     * Initializes the <code>PatternGroup</code> by the File <code>file</code>.
     *
     * @param file
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>PatternGroup</code>
     * by the String representation of URI <code>uri</code>.
     *
     * @param uri
     * @exception IOException
    ...
    /**
     * Initializes the <code>PatternGroup</code> by the URL <code>url</code>.
     *
     * @param url
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>PatternGroup</code> by the InputStream <code>in</code>.
     *
     * @param in
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>PatternGroup</code> by the InputSource <code>is</code>.
     *
     * @param is
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>PatternGroup</code> by the Reader <code>reader</code>.
     *
     * @param reader
     * @exception IOException
     * @exception SAXException
    ...
    public void makeTextElement(StringBuffer buffer) {
        ...
        buffer.append("<");
        URelaxer.makeQName(prefix, "group", buffer);
     ...
     * for the <code>PatternGroup</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://relaxng.org/ns/structure/1.0", "group")) {
            return (false);
        }
     ...
     * is valid for the <code>PatternGroup</code>.
