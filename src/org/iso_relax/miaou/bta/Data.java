...
/**
 * <b>Data</b> is generated from binaryTreeAutomaton.rngby Relaxer.
 ...
 */
public class Data implements java.io.Serializable, IRNSContainer, IDataChoice, IRVisitable, IRNode, IAtomicTransitionChoice {
    ...
    private void init(Element element) {
        ...
        while (!stack.isEmptyElement()) {
            if (Data.isMatch(stack)) {
                ...
                if (!URelaxer2.consumeElement(stack, "http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton")) {
                    break;
        }
            }
        }
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton", "data");
    ...
    public final void setContent(IDataChoice[] content) {
        ...
        for (int i = 0;i < content.length;i++) {
            content[i].setRContext(getRContext());
        }
    }
    ...
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton", "data")) {
            return (false);
        }
        ...
        while (!target.isEmptyElement()) {
            if (Data.isMatchHungry(target)) {
                ...
                if (!URelaxer2.consumeElement(target, "http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton")) {
                    break;
        }
            }
        }
