...
/**
 * <b>NonExistentAttributeTransition</b> is generated from binaryTreeAutomaton.rngby Relaxer.
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;element name="nonExistentAttributeTransition" relaxer:implements="java.lang.Cloneable"&gt;
 *   &lt;ref name="target"/&gt;
 *   &lt;ref name="nameClass"/&gt;
 *   &lt;optional&gt;
 *     &lt;ref name="exceptNameClass"/&gt;
 ...
 */
public class NonExistentAttributeTransition implements java.io.Serializable, IRNSContainer, java.lang.Cloneable, IRVisitable, IRNode {
     ...
     *
     */
    public NonExistentAttributeTransition() {
    }
     ...
     * @param stack
     */
    public NonExistentAttributeTransition(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public NonExistentAttributeTransition(Document doc) {
     ...
     * @param element
     */
    public NonExistentAttributeTransition(Element element) {
        setup(element);
    }
     ...
     */
    public NonExistentAttributeTransition(File file) throws IOException, SAXException, ParserConfigurationException {
        setup(file);
    }
     ...
     * @exception ParserConfigurationException
     */
    public NonExistentAttributeTransition(String uri) throws IOException, SAXException, ParserConfigurationException {
        setup(uri);
    }
     ...
     * @exception ParserConfigurationException
     */
    public NonExistentAttributeTransition(URL url) throws IOException, SAXException, ParserConfigurationException {
        setup(url);
    }
     ...
     * @exception ParserConfigurationException
     */
    public NonExistentAttributeTransition(InputStream in) throws IOException, SAXException, ParserConfigurationException {
        setup(in);
    }
     ...
     * @exception ParserConfigurationException
     */
    public NonExistentAttributeTransition(InputSource is) throws IOException, SAXException, ParserConfigurationException {
        setup(is);
    }
     ...
     * @exception ParserConfigurationException
     */
    public NonExistentAttributeTransition(Reader reader) throws IOException, SAXException, ParserConfigurationException {
        setup(reader);
    }

    /**
     * Initializes the <code>NonExistentAttributeTransition</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>NonExistentAttributeTransition</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>NonExistentAttributeTransition</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton", "nonExistentAttributeTransition");
    ...
    /**
     * Initializes the <code>NonExistentAttributeTransition</code> by the File <code>file</code>.
     *
     * @param file
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>NonExistentAttributeTransition</code>
     * by the String representation of URI <code>uri</code>.
     *
     * @param uri
     * @exception IOException
    ...
    /**
     * Initializes the <code>NonExistentAttributeTransition</code> by the URL <code>url</code>.
     *
     * @param url
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>NonExistentAttributeTransition</code> by the InputStream <code>in</code>.
     *
     * @param in
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>NonExistentAttributeTransition</code> by the InputSource <code>is</code>.
     *
     * @param is
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>NonExistentAttributeTransition</code> by the Reader <code>reader</code>.
     *
     * @param reader
     * @exception IOException
     * @exception SAXException
     ...
     * for the <code>NonExistentAttributeTransition</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton", "nonExistentAttributeTransition")) {
            return (false);
        }
     ...
     * is valid for the <code>NonExistentAttributeTransition</code>.
