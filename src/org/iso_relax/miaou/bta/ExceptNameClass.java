...
/**
 * <b>ExceptNameClass</b> is generated by Relaxer based on binaryTreeAutomaton.rng.
...
public class ExceptNameClass implements java.io.Serializable, IRNSContainer, IRVisitable, IRNode {
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton", "except");
    ...
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton", "except")) {
            return (false);
        }
