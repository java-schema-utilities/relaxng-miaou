...
/**
 * <b>TextTransition</b> is generated from binaryTreeAutomaton.rngby Relaxer.
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;element name="textTransition" relaxer:implements="java.lang.Cloneable"&gt;
 *   &lt;ref name="target"/&gt;
 *   &lt;ref name="right"/&gt;
 * &lt;/element&gt;
 * </pre>
 ...
 */
public class TextTransition implements java.io.Serializable, IRNSContainer, java.lang.Cloneable, IRVisitable, IRNode {
     ...
     * @param stack
     */
    public TextTransition(RStack stack) {
        setup(stack);
    }
     ...
     * @param element
     */
    public TextTransition(Element element) {
        setup(element);
    }
     ...
     */
    public TextTransition(File file) throws IOException, SAXException, ParserConfigurationException {
        setup(file);
    }
     ...
     * @exception ParserConfigurationException
     */
    public TextTransition(String uri) throws IOException, SAXException, ParserConfigurationException {
        setup(uri);
    }
     ...
     * @exception ParserConfigurationException
     */
    public TextTransition(URL url) throws IOException, SAXException, ParserConfigurationException {
        setup(url);
    }
     ...
     * @exception ParserConfigurationException
     */
    public TextTransition(InputStream in) throws IOException, SAXException, ParserConfigurationException {
        setup(in);
    }
     ...
     * @exception ParserConfigurationException
     */
    public TextTransition(InputSource is) throws IOException, SAXException, ParserConfigurationException {
        setup(is);
    }
     ...
     * @exception ParserConfigurationException
     */
    public TextTransition(Reader reader) throws IOException, SAXException, ParserConfigurationException {
        setup(reader);
    }

    /**
     * Initializes the <code>TextTransition</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>TextTransition</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>TextTransition</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton", "textTransition");
    ...
    /**
     * Initializes the <code>TextTransition</code>
     * by the String representation of URI <code>uri</code>.
     *
     * @param uri
     * @exception IOException
    ...
    /**
     * Initializes the <code>TextTransition</code> by the InputStream <code>in</code>.
     *
     * @param in
     * @exception IOException
     * @exception SAXException
     ...
     * for the <code>TextTransition</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton", "textTransition")) {
            return (false);
        }
     ...
     * is valid for the <code>TextTransition</code>.
