...
/**
 * <b>Param</b> is generated from binaryTreeAutomaton.rngby Relaxer.
 ...
 */
public class Param implements java.io.Serializable, IRNSContainer, IRVisitable, IRNode {
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton", "param");
    ...
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.iso_relax.org/xmlns/miaou/binaryTreeAutomaton", "param")) {
            return (false);
        }
