...
/**
 * <b>BinaryTreeGrammarRule</b> is generated from binaryTreeGrammar.rngby Relaxer.
 ...
 */
public class BinaryTreeGrammarRule implements java.io.Serializable, IRNSContainer, IRNode {
     ...
     * @param stack
     */
    public BinaryTreeGrammarRule(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public BinaryTreeGrammarRule(Document doc) {
     ...
     * @param element
     */
    public BinaryTreeGrammarRule(Element element) {
        setup(element);
    }
     ...
     */
    public BinaryTreeGrammarRule(File file) throws IOException, SAXException, ParserConfigurationException {
        setup(file);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BinaryTreeGrammarRule(String uri) throws IOException, SAXException, ParserConfigurationException {
        setup(uri);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BinaryTreeGrammarRule(URL url) throws IOException, SAXException, ParserConfigurationException {
        setup(url);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BinaryTreeGrammarRule(InputStream in) throws IOException, SAXException, ParserConfigurationException {
        setup(in);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BinaryTreeGrammarRule(InputSource is) throws IOException, SAXException, ParserConfigurationException {
        setup(is);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BinaryTreeGrammarRule(Reader reader) throws IOException, SAXException, ParserConfigurationException {
        setup(reader);
    }

    /**
     * Initializes the <code>BinaryTreeGrammarRule</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarRule</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarRule</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://www.iso_relax.org/xmlns/miaou/binaryTreeGrammar", "Rule");
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarRule</code> by the File <code>file</code>.
     *
     * @param file
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarRule</code>
     * by the String representation of URI <code>uri</code>.
     *
     * @param uri
     * @exception IOException
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarRule</code> by the URL <code>url</code>.
     *
     * @param url
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarRule</code> by the InputStream <code>in</code>.
     *
     * @param in
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarRule</code> by the InputSource <code>is</code>.
     *
     * @param is
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarRule</code> by the Reader <code>reader</code>.
     *
     * @param reader
     * @exception IOException
     * @exception SAXException
    ...
    public void makeTextElement(StringBuffer buffer) {
        ...
        buffer.append("<");
        URelaxer.makeQName(prefix, "Rule", buffer);
     ...
     * for the <code>BinaryTreeGrammarRule</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.iso_relax.org/xmlns/miaou/binaryTreeGrammar", "Rule")) {
            return (false);
        }
     ...
     * is valid for the <code>BinaryTreeGrammarRule</code>.
