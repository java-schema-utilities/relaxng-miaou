...
/**
 * <b>Value</b> is generated from binaryTreeGrammar.rngby Relaxer.
 ...
 */
public class Value implements java.io.Serializable, IRNSContainer, IRNode, IDataChoice, IBtrExpAtomicChoice1 {
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://www.iso_relax.org/xmlns/miaou/binaryTreeGrammar", "Value");
    ...
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.iso_relax.org/xmlns/miaou/binaryTreeGrammar", "Value")) {
            return (false);
        }
