...
/**
 * <b>BinaryTreeGrammarStart</b> is generated from binaryTreeGrammar.rngby Relaxer.
 ...
 */
public class BinaryTreeGrammarStart implements java.io.Serializable, IRNSContainer, IRNode {
     ...
     * @param stack
     */
    public BinaryTreeGrammarStart(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public BinaryTreeGrammarStart(Document doc) {
     ...
     * @param element
     */
    public BinaryTreeGrammarStart(Element element) {
        setup(element);
    }
     ...
     */
    public BinaryTreeGrammarStart(File file) throws IOException, SAXException, ParserConfigurationException {
        setup(file);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BinaryTreeGrammarStart(String uri) throws IOException, SAXException, ParserConfigurationException {
        setup(uri);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BinaryTreeGrammarStart(URL url) throws IOException, SAXException, ParserConfigurationException {
        setup(url);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BinaryTreeGrammarStart(InputStream in) throws IOException, SAXException, ParserConfigurationException {
        setup(in);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BinaryTreeGrammarStart(InputSource is) throws IOException, SAXException, ParserConfigurationException {
        setup(is);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BinaryTreeGrammarStart(Reader reader) throws IOException, SAXException, ParserConfigurationException {
        setup(reader);
    }

    /**
     * Initializes the <code>BinaryTreeGrammarStart</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarStart</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarStart</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://www.iso_relax.org/xmlns/miaou/binaryTreeGrammar", "Start");
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarStart</code> by the File <code>file</code>.
     *
     * @param file
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarStart</code>
     * by the String representation of URI <code>uri</code>.
     *
     * @param uri
     * @exception IOException
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarStart</code> by the URL <code>url</code>.
     *
     * @param url
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarStart</code> by the InputStream <code>in</code>.
     *
     * @param in
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarStart</code> by the InputSource <code>is</code>.
     *
     * @param is
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BinaryTreeGrammarStart</code> by the Reader <code>reader</code>.
     *
     * @param reader
     * @exception IOException
     * @exception SAXException
     ...
     * for the <code>BinaryTreeGrammarStart</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.iso_relax.org/xmlns/miaou/binaryTreeGrammar", "Start")) {
            return (false);
        }
     ...
     * is valid for the <code>BinaryTreeGrammarStart</code>.
