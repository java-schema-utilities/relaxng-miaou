...
/**
 * <b>BinaryTreeGrammar</b> is generated by Relaxer based on binaryTreeGrammar.rng.
 ...
 */
public class BinaryTreeGrammar implements java.io.Serializable, IRNSContainer, IRVisitable, IRNode {
    ...
    public final void setBinaryTreeGrammarRule(BinaryTreeGrammarRule[] binaryTreeGrammarRule) {
        ...
        this.binaryTreeGrammarRule_.addAll(java.util.Arrays.asList(binaryTreeGrammarRule));
    ...
    public final void removeBinaryTreeGrammarRule(int index) {
        binaryTreeGrammarRule_.remove(index);
    }
