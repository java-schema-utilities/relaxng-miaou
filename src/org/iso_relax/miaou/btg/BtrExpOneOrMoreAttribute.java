...
/**
 * <b>BtrExpOneOrMoreAttribute</b> is generated from binaryTreeGrammar.rngby Relaxer.
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;element name="OneOrMoreAttribute"&gt;
 *   &lt;ref name="nameClass"/&gt;
 *   &lt;ref name="btrExp"/&gt;
 *   &lt;ref name="btrExp"/&gt;
 * &lt;/element&gt;
 ...
 */
public class BtrExpOneOrMoreAttribute implements java.io.Serializable, IRNSContainer, IRNode, IBtrExpChoice {
     ...
     *
     */
    public BtrExpOneOrMoreAttribute() {
    }
     ...
     * @param stack
     */
    public BtrExpOneOrMoreAttribute(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public BtrExpOneOrMoreAttribute(Document doc) {
     ...
     * @param element
     */
    public BtrExpOneOrMoreAttribute(Element element) {
        setup(element);
    }
     ...
     */
    public BtrExpOneOrMoreAttribute(File file) throws IOException, SAXException, ParserConfigurationException {
        setup(file);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BtrExpOneOrMoreAttribute(String uri) throws IOException, SAXException, ParserConfigurationException {
        setup(uri);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BtrExpOneOrMoreAttribute(URL url) throws IOException, SAXException, ParserConfigurationException {
        setup(url);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BtrExpOneOrMoreAttribute(InputStream in) throws IOException, SAXException, ParserConfigurationException {
        setup(in);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BtrExpOneOrMoreAttribute(InputSource is) throws IOException, SAXException, ParserConfigurationException {
        setup(is);
    }
     ...
     * @exception ParserConfigurationException
     */
    public BtrExpOneOrMoreAttribute(Reader reader) throws IOException, SAXException, ParserConfigurationException {
        setup(reader);
    }

    /**
     * Initializes the <code>BtrExpOneOrMoreAttribute</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>BtrExpOneOrMoreAttribute</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>BtrExpOneOrMoreAttribute</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElementNS("http://www.iso_relax.org/xmlns/miaou/binaryTreeGrammar", "OneOrMoreAttribute");
    ...
    /**
     * Initializes the <code>BtrExpOneOrMoreAttribute</code> by the File <code>file</code>.
     *
     * @param file
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BtrExpOneOrMoreAttribute</code>
     * by the String representation of URI <code>uri</code>.
     *
     * @param uri
     * @exception IOException
    ...
    /**
     * Initializes the <code>BtrExpOneOrMoreAttribute</code> by the URL <code>url</code>.
     *
     * @param url
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BtrExpOneOrMoreAttribute</code> by the InputStream <code>in</code>.
     *
     * @param in
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BtrExpOneOrMoreAttribute</code> by the InputSource <code>is</code>.
     *
     * @param is
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>BtrExpOneOrMoreAttribute</code> by the Reader <code>reader</code>.
     *
     * @param reader
     * @exception IOException
     * @exception SAXException
     ...
     * for the <code>BtrExpOneOrMoreAttribute</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.iso_relax.org/xmlns/miaou/binaryTreeGrammar", "OneOrMoreAttribute")) {
            return (false);
        }
     ...
     * is valid for the <code>BtrExpOneOrMoreAttribute</code>.
